 ...
 * - $page['footer_fourthcolumn']: Items for the fourth footer column.
  * - $page['footer_fourthcolumn']: Items for the fifth footer column.
...
$header_background_fid = theme_get_setting('backgroung_header_img');
$header_background_file = $header_background_fid ? file_load($header_background_fid) : FALSE;
$header_background = $header_background_file ? file_create_url($header_background_file->uri) : '';
?>
<div id="page-wrapper"><div id="page">
      ...
      <?php endif; ?>
  <div id="header" style="background-image: url(<?php print $header_background;?>);"class="<?php print $secondary_menu ? 'with-secondary-menu': 'without-secondary-menu'; ?>">
